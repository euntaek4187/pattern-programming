...
public class GMultiply extends GShape{
	private int px, py;

	@Override
	public GShape clone() {
		return new GMultiply();
	}
	...
	public void resizePoint(int lastX, int lastY) {
		...
		polygon.xpoints[1] = middleX-minX*2;
		polygon.xpoints[2] = middleX;
		polygon.xpoints[3] = middleX+minX*2;
		polygon.xpoints[4] = lastX;
		polygon.xpoints[5] = middleX+minX*2;
		polygon.xpoints[6] = lastX;
		polygon.xpoints[7] = middleX+minX*2;
		polygon.xpoints[8] = middleX;
		polygon.xpoints[9] = middleX-minX*2;
		polygon.xpoints[10] = firtsX;
		polygon.xpoints[11] = middleX-minX*2;

		polygon.ypoints[0] = middleY-minY*2;
		polygon.ypoints[1] = firtsY;
		polygon.ypoints[2] = middleY-minY*2;
		polygon.ypoints[3] = firtsY;
		polygon.ypoints[4] = middleY-minY*2;
		polygon.ypoints[5] = middleY;
		polygon.ypoints[6] = middleY+minY*2;
		polygon.ypoints[7] = lastY;
		polygon.ypoints[8] = middleY+minY*2;
		polygon.ypoints[9] = lastY;
		polygon.ypoints[10] = middleY+minY*2;
		polygon.ypoints[11] = middleY;
	}
