...
public class GBigStar extends GShape{
	private int px, py;
	...
	public void resizePoint(int lastX, int lastY) {
		...
		polygon.xpoints[5] = lastX-minX*2;
		...
		polygon.ypoints[1] = middleY-minY*2;
		polygon.ypoints[2] = firtsY;
		polygon.ypoints[3] = middleY-minY*2;
		...
		polygon.ypoints[9] = middleY+minY*2;
